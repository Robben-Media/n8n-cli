...
import (
	...
	"github.com/builtbyrobben/n8n-cli/internal/errfmt"
...
type CLI struct {
	...
	Workflows   WorkflowsCmd     `cmd:"" help:"Workflow operations"`
	Executions  ExecutionsCmd    `cmd:"" help:"Execution operations"`
	Credentials CredentialsCmd   `cmd:"" help:"Credential operations"`
	Tags        TagsCmd          `cmd:"" help:"Tag operations"`
	Variables   VariablesCmd     `cmd:"" help:"Variable operations"`
	Webhooks    WebhooksCmd      `cmd:"" help:"Webhook operations"`
	Health      HealthCmd        `cmd:"" help:"Check n8n health"`
...
func newParser(description string) (*kong.Kong, *CLI, error) {
	envMode := outfmt.FromEnv("N8N_CLI")
	vars := kong.Vars{
		"color":   envOr("N8N_CLI_COLOR", "auto"),
